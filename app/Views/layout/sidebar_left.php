<aside class="relative col-span-12 flex flex-col justify-between border-chinjufu-line bg-chinjufu-panel/40 py-8 lg:col-span-2 lg:border-r lg:px-5">
  ...
  <nav class="flex flex-col gap-1">
    <?php
      $sideMenu = [
        ['label' => 'Dashboard',    'icon' => 'M4 4h7v7H4V4Zm9 0h7v7h-7V4ZM4 13h7v7H4v-7Zm9 0h7v7h-7v-7Z', 'active' => true],
        ['label' => 'Museum Kapal', 'icon' => 'M3 18l2-7h14l2 7M6 11V6h12v5M9 21v-3h6v3'],
        ['label' => 'Hall of Fame', 'icon' => 'M6 3h12v4a6 6 0 0 1-12 0V3ZM4 5h2M18 5h2M9 17h6v4H9v-4Z'],
        ['label' => 'Roll of Honor','icon' => 'M12 2v20M6 8h12M4 14h16a8 8 0 0 1-16 0Z'],
        ['label' => 'Event Log',    'icon' => 'M4 5h16v15H4V5Zm0 5h16M8 3v4M16 3v4'],
        ['label' => 'Pengaturan',   'icon' => 'M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm7-3a7 7 0 0 0-.14-1.4l2-1.56-2-3.46-2.36.96a7 7 0 0 0-2.4-1.4L13.6 2h-3.2l-.5 2.14a7 7 0 0 0-2.4 1.4l-2.36-.96-2 3.46 2 1.56A7 7 0 0 0 5 12c0 .48.05.94.14 1.4l-2 1.56 2 3.46 2.36-.96c.7.6 1.52 1.08 2.4 1.4l.5 2.14h3.2l.5-2.14a7 7 0 0 0 2.4-1.4l2.36.96 2-3.46-2-1.56c.09-.46.14-.92.14-1.4Z'],
      ];
    ?>
